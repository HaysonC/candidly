...
"[project]/app/dashboard/start-interview/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StartInterviewPage() {
    ...
    const [joinLink, setJoinLink] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StartInterviewPage.useEffect": ()=>{
            ...
            setUsername(name);
            const load = {
                "StartInterviewPage.useEffect.load": async ()=>{
                    setTemplatesLoading(true);
                    try {
                        const arr = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$templates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTemplatesForAccount"])(name);
                        const opts = Array.isArray(arr) ? arr.map({
                            "StartInterviewPage.useEffect.load": (t)=>({
                                    id: String(t.id),
                                    name: t.name || 'Untitled'
                                })
                        }["StartInterviewPage.useEffect.load"]) : [];
                        setTemplates(opts);
                    } catch  {
                        setTemplates([]);
                    } finally{
            ...
            load();
            const onVis = {
                "StartInterviewPage.useEffect.onVis": ()=>{
                    if (document.visibilityState === 'visible') load();
                }
            }["StartInterviewPage.useEffect.onVis"];
            document.addEventListener('visibilitychange', onVis);
            return ({
                "StartInterviewPage.useEffect": ()=>document.removeEventListener('visibilitychange', onVis)
            })["StartInterviewPage.useEffect"];
        }
    }["StartInterviewPage.useEffect"], [
        router
    ...
    const refreshTemplates = async ()=>{
        ...
        setTemplatesLoading(true);
        try {
            const arr = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$templates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTemplatesForAccount"])(username);
    ...
    const handleCreateSession = async ()=>{
        ...
        setIsCreating(true);
        try {
            const signalingServer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_SIGNALING_SERVER || "http://localhost:8000";
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$arrow$2d$left$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ArrowLeft$3e$__["ArrowLeft"], {
                                        ...
                                        fileName: "[project]/app/dashboard/start-interview/page.tsx",
                                        lineNumber: 162,
                                        columnNumber: 15
                                    }, this),
                                    "Back to Dashboard"
...
_s(StartInterviewPage, "5pIaEPQh+GVeMCEG0YysP6qjTmo=", false, function() {
    return [
...
//# sourceMappingURL=_089e44ef._.js.map